...
TNAMSE_and_HPO_flat[] <- lapply(TNAMSE_and_HPO_flat, function(col) {
  ...
  print("Finished writing UMAP CSV")
  return(TRUE)
}
"""
...
def generate_umap(tnamse_data, lab, selected_case_id, redo):
    ...
    # # Filter TNAMSE_and_HPO to only include cases sent by frontend
    # TNAMSE_and_HPO = pd.read_csv(labFile)
    
    # # Ensure IDs match format
    # TNAMSE_and_HPO['case_ID_paper'] = TNAMSE_and_HPO['case_ID_paper'].astype(str)
    # tnamse_data['case_ID_paper'] = tnamse_data['case_ID_paper'].astype(str)

    # # Filter full TNAMSE_and_HPO with only the passed cases (with date filter applied)
    # TNAMSE_and_HPO = TNAMSE_and_HPO[TNAMSE_and_HPO['case_ID_paper'].isin(tnamse_data['case_ID_paper'])]
    ...
    #     "endocrine, metabolic, mitochondrial nutritional": "rgb(255,215,0)",  # Gold
    #     "endocrine": "rgb(255,215,0)",  # Gold
    #     "metabolic": "rgb(255, 102, 204)",  # Pink
    ...
    #     "haematopoiesis/immune system": "rgb(112,173,71)",  # Green
    #     "organ abnormality": "rgb(122, 0, 255)",  # Pinkish
    #     "neurological neuromuscular": "rgb(177,160,199)", # Light lilac
    #     "neurological/neuromuscular": "rgb(177,160,199)",   # Light lilac
    #     "unspecified": "rgb(153, 102, 51)", # Brown
    #     "other": "rgb(0, 255, 196)" # Turquoise
    # }

    # # Mapping of disease categories to RGB colors
    # color_map = {
    #     "cardiovascular": "rgb(255,0,0)",               # Red
    #     "neurological": "rgb(34,139,34)",               # Forest Green
    #     "neurodevelopmental": "rgb(0,255,0)",           # Green
    #     "metabolism/homeostasis": "rgb(255,165,0)",     # Orange
    #     "musculoskeletal": "rgb(200,0,200)",            # Purple
    #     "genitourinary": "rgb(0,255,255)",              # Cyan
    #     "digestive system": "rgb(255,20,147)",          # Deep Pink
    #     "respiratory": "rgb(75,0,130)",                 # Indigo
    #     "immune system": "rgb(255,215,0)",              # Gold
    #     "hematopoietic": "rgb(139,69,19)",              # Saddle Brown
    #     "endocrine": "rgb(0,191,255)",                  # Deep Sky Blue
    #     "eye": "rgb(0,128,128)",                        # Teal
    #     "ear": "rgb(0,0,255)",                          # Blue
    #     "integument": "rgb(255,105,180)",               # Hot Pink
    #     "head or neck": "rgb(128,0,0)",                 # Maroon
    #     "voice": "rgb(255,69,0)",                       # Orange Red
    #     "limbs": "rgb(0,100,0)",                        # Dark Green
    #     "breast": "rgb(75,0,130)",                      # Indigo
    #     "thoracic cavity": "rgb(30,144,255)",           # Dodger Blue
    #     "prenatal development or birth": "rgb(186,85,211)", # Medium Orchid
    #     "unspecified": "rgb(169,169,169)"              # Dark Gray
    # }


    # Mapping of disease categories to RGB colors
    color_map = {
        "overlap": "rgb(185, 142, 125)",                    # Brownish
        "neurodevelopmental": "rgb(114, 118, 251)",         # Bluish
        "immune system": "rgb(242, 200, 123)",              # Yellowish
    }
    ...
    fig.update_layout(title="UMAP Visualization", autosize=True, width=1600, height=1200)
    fig.write_image("umap_IEI.svg")
